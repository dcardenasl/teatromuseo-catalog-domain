...
### Programa cross-repo — Catalog PublicRead
...
- [x] **CACHE-03** — Invalidación y regeneración asíncrona completada (2026-08-09).
  Las mutaciones públicas de categorías, técnicas y piezas registran un outbox
  transaccional; `cache:dispatch-outbox` entrega a Web con lease, reintentos e
  idempotencia. No se hace HTTP durante el request de escritura.
