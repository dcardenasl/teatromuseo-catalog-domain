...
/**
 * HTTP smoke test for CollectionItemController. The configured route group
 ...
 * @internal
 */
final class CollectionItemControllerTest extends CIUnitTestCase
{
    ...
    {
        $result = $this->get('/api/v1/catalog/collection-items');
    ...
    {
        $result = $this->get('/api/v1/catalog/collection-items/99999');
