...
/**
 * HTTP smoke test for TechniqueController. The configured route group
 ...
 * @internal
 */
final class TechniqueControllerTest extends CIUnitTestCase
{
    ...
    {
        $result = $this->get('/api/v1/catalog/techniques');
    ...
    {
        $result = $this->get('/api/v1/catalog/techniques/99999');
